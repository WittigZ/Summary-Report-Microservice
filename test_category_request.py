...
# Example request for a category summary report
request_data = {
...
# Send category summary request to the microservice
with open(REQUEST_FILE, "w") as file:
    json.dump(request_data, file, indent=4)

print("Category summary request sent.")
...
print("Category summary response received:")
